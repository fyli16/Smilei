...
#ifndef ELECTROMAGNBC1D_DAMPING_H
#define ELECTROMAGNBC1D_DAMPING_H
...
//! Field-damping "mask" boundary condition (1D).
//!
...
class ElectroMagnBC1D_Damping : public ElectroMagnBC1D
{
public:
    ElectroMagnBC1D_Damping( Params &params, Patch *patch, unsigned int i_boundary );
    ~ElectroMagnBC1D_Damping() {};
